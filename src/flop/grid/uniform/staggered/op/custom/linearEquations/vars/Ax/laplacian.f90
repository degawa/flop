...
!>@endnote
!>
module grid_uniform_staggered_op_custom_linEqs_vars_Ax_laplacian
...
contains
    ...
    function construct_Ax_laplacian(x) result(new_Ax_lap)
        use :: grid_uniform_staggered_op_custom_linEqs_vars_solver_lap_SOR
        implicit none
...
end module grid_uniform_staggered_op_custom_linEqs_vars_Ax_laplacian
