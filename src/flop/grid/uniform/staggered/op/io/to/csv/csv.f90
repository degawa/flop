...
!>
module grid_uniform_stg_op_io_to_csv
    use, intrinsic :: iso_fortran_env
    use :: grid_uniform_stg_op_io_vars_scalar_writer_csv
    use :: grid_uniform_stg_op_io_vars_vector_writer_csv
    implicit none
    private
    public :: set_unit_number_to_scr2dcsvwriter
    public :: set_unit_number_to_vec2dcsvwriter
    public :: set_unit_number_from_filename_to_scr2dcsvwriter
    public :: set_unit_number_from_filename_to_vec2dcsvwriter
...
contains
    ...
    function set_unit_number_from_filename_to_scr2dcsvwriter(scr_writer, filename) result(new_scr_writer)
        ...
        new_scr_writer%scr = scr_writer%scr
        new_scr_writer%unit_number = unit(filename//csv_extension)
    ...
    function set_unit_number_from_filename_to_vec2dcsvwriter(vec_writer, filename) result(new_vec_writer)
        ...
        new_vec_writer%vec = vec_writer%vec
        new_vec_writer%unit_number = unit(filename//csv_extension)
    end function set_unit_number_from_filename_to_vec2dcsvwriter
end module grid_uniform_stg_op_io_to_csv
